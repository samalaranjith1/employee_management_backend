...
export default function SalesAnalytics() {
  ...
  const {
    ...
    filters: { department: "", masterProduct: "", product: "" },
    startDate: null,
    endDate: null,
  ...
  const handleAnalyse = () => {
    console.log("Analyser clicked with:", {
      ...
      masterProduct: filters.masterProduct,
        ...
        <ServiceRenderer
          ...
          queryKey={[
            "salesProductsDailyList",
            {
              ...
              masterproducts: filters.masterProduct || null,
              products: filters.product || null,
            },
          ]}
          queryFn={() =>
            ...
            <AnalyticsPage
              ...
              filters={[
                ...
                },
                {
                  ...
                  onChange: (val) =>
                    setFilters((f) => ({ ...f, masterProduct: val })),
                },
                {
                  label: "Products",
