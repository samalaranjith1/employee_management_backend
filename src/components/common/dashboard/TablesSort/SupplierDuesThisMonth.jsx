...
import SupplierDetailsTableMonth from "./SupplierDetailsTableMonth";
...
export default function SupplierDuesThisMonth() {
  ...
  const monthData = {
    August: {
      ...
      pie: [],
      suppliersList: [
        { supplier: "ABC Corp", purchase: 200000, items: 50 },
        { supplier: "XYZ Ltd", purchase: 150000, items: 30 },
      ],
    },
    July: {
      total: 720000,
      ...
      pie: [],
      suppliersList: [
        { supplier: "ABC Corp", purchase: 180000, items: 45 },
        { supplier: "XYZ Ltd", purchase: 120000, items: 28 },
      ],
    },
  };
    ...
    <Card style={styles.container} className="m-2">
      ...
      >
        ...
        <Row>
          ...
          <Col md={6}>
            <SupplierDetailsTableMonth data={data.suppliersList} styles={styles} />
          </Col>
        </Row>
      </BaseSurface>
    </Card>
