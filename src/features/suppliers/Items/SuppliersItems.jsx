...
import SuppliersItemsTable from "@/components/common/suppliers/TableSort/Items/SuppliersItemsTable";
...
const SuppliersItems = () => {
  ...
  return (
    <ServiceRenderer
      ...
      formatter={suppliersItemsDataFormatter}
      shimmerCount={1}
    >
      {(formattedData) => {
        const { items } = formattedData;
        return <SuppliersItemsTable items={items} />;
      }}
    </ServiceRenderer>
  );
};
